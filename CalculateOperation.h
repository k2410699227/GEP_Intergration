...
namespace CalculateOperation
{
    ...
    //单目运算
    double calculation(char ch, double a) { return 0; }
    //双目运算
    ...
    //三目运算
    double calculation(char ch, double a, double b, double c) { return 0; }
    //返回用于校验的表达式字符串
    ...
    std::string getExpression(char ch, std::string a, std::string b, std::string c) { return 0; };
